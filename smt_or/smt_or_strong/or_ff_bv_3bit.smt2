...
;; =====================
;; Range check polynomial for foutput in [0, 2^3)
;; =====================
(define-fun RC_8 ((x FF)) FF
  ...
  (ff.add x (ff.mul neg_one #f7m52435875175126190479447740508185965837690552500527637822603658699938581184513))))))))))
(assert (= (RC_8 foutput) zero))
