;; Auto-generated (FF, flat) from Lean subtable: XOR_16
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (as ff0 F) (ff.mul (as ff1 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_7)) fv2_7) (ff.mul fv1_7 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_7)))))) (ff.mul (as ff2 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_6)) fv2_6) (ff.mul fv1_6 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_6)))))) (ff.mul (as ff4 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_5)) fv2_5) (ff.mul fv1_5 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_5)))))) (ff.mul (as ff8 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_4)) fv2_4) (ff.mul fv1_4 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_4)))))) (ff.mul (as ff16 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_3)) fv2_3) (ff.mul fv1_3 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_3)))))) (ff.mul (as ff32 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_2)) fv2_2) (ff.mul fv1_2 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_2)))))) (ff.mul (as ff64 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_1)) fv2_1) (ff.mul fv1_1 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_1)))))) (ff.mul (as ff128 F) (ff.add (ff.mul (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_0)) fv2_0) (ff.mul fv1_0 (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv2_0)))))))
