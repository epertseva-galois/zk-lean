;; Auto-generated (FF, flat) from Lean subtable: AND_16
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (as ff0 F) (ff.mul (ff.mul (as ff1 F) fv1_7) fv2_7)) (ff.mul (ff.mul (as ff2 F) fv1_6) fv2_6)) (ff.mul (ff.mul (as ff4 F) fv1_5) fv2_5)) (ff.mul (ff.mul (as ff8 F) fv1_4) fv2_4)) (ff.mul (ff.mul (as ff16 F) fv1_3) fv2_3)) (ff.mul (ff.mul (as ff32 F) fv1_2) fv2_2)) (ff.mul (ff.mul (as ff64 F) fv1_1) fv2_1)) (ff.mul (ff.mul (as ff128 F) fv1_0) fv2_0)))
