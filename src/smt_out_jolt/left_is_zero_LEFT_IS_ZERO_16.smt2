;; Auto-generated (FF, flat) from Lean subtable: LEFT_IS_ZERO_16
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (as ff1 F) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_0))) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_1))) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_2))) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_3))) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_4))) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_5))) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_6))) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_7))))
...
(assert (not (= bvoutput (ite (= bv1 (_ bv0 8))
              (_ bv1 8) (_ bv0 8)))))
