;; Auto-generated (FF, flat) from Lean subtable: DIV_BY_ZERO_16
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (as ff1 F) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_0))) fv2_0) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_1))) fv2_1) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_2))) fv2_2) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_3))) fv2_3) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_4))) fv2_4) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_5))) fv2_5) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_6))) fv2_6) (ff.add (as ff1 F) (ff.mul (as ff18446744073709551556 F) fv1_7))) fv2_7))
...
(assert (not (= bvoutput (ite (and (= bv1 (_ bv0 8))
             (= bv2 (_ bv255 8))) (_ bv1 8) (_ bv0 8)))))
