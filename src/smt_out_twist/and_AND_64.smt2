;; Auto-generated (FF, flat) from Lean subtable: AND_64
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (ff.add (as ff0 F) (ff.mul (ff.mul (as ff2147483648 F) fv1_0) fv1_1)) (ff.mul (ff.mul (as ff1073741824 F) fv1_2) fv1_3)) (ff.mul (ff.mul (as ff536870912 F) fv1_4) fv1_5)) (ff.mul (ff.mul (as ff268435456 F) fv1_6) fv1_7)) (ff.mul (ff.mul (as ff134217728 F) fv1_8) fv1_9)) (ff.mul (ff.mul (as ff67108864 F) fv1_10) fv1_11)) (ff.mul (ff.mul (as ff33554432 F) fv1_12) fv1_13)) (ff.mul (ff.mul (as ff16777216 F) fv1_14) fv1_15)) (ff.mul (ff.mul (as ff8388608 F) fv1_16) fv1_17)) (ff.mul (ff.mul (as ff4194304 F) fv1_18) fv1_19)) (ff.mul (ff.mul (as ff2097152 F) fv1_20) fv1_21)) (ff.mul (ff.mul (as ff1048576 F) fv1_22) fv1_23)) (ff.mul (ff.mul (as ff524288 F) fv1_24) fv1_25)) (ff.mul (ff.mul (as ff262144 F) fv1_26) fv1_27)) (ff.mul (ff.mul (as ff131072 F) fv1_28) fv1_29)) (ff.mul (ff.mul (as ff65536 F) fv1_30) fv1_31)) (ff.mul (ff.mul (as ff32768 F) fv2_0) fv2_1)) (ff.mul (ff.mul (as ff16384 F) fv2_2) fv2_3)) (ff.mul (ff.mul (as ff8192 F) fv2_4) fv2_5)) (ff.mul (ff.mul (as ff4096 F) fv2_6) fv2_7)) (ff.mul (ff.mul (as ff2048 F) fv2_8) fv2_9)) (ff.mul (ff.mul (as ff1024 F) fv2_10) fv2_11)) (ff.mul (ff.mul (as ff512 F) fv2_12) fv2_13)) (ff.mul (ff.mul (as ff256 F) fv2_14) fv2_15)) (ff.mul (ff.mul (as ff128 F) fv2_16) fv2_17)) (ff.mul (ff.mul (as ff64 F) fv2_18) fv2_19)) (ff.mul (ff.mul (as ff32 F) fv2_20) fv2_21)) (ff.mul (ff.mul (as ff16 F) fv2_22) fv2_23)) (ff.mul (ff.mul (as ff8 F) fv2_24) fv2_25)) (ff.mul (ff.mul (as ff4 F) fv2_26) fv2_27)) (ff.mul (ff.mul (as ff2 F) fv2_28) fv2_29)) (ff.mul (ff.mul (as ff1 F) fv2_30) fv2_31)))
...
(assert (not (= bvoutput (bvand bv1 bv2))))
