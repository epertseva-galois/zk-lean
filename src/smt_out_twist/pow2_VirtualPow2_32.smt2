;; Auto-generated (FF, flat) from Lean subtable: VirtualPow2_32
(set-logic ALL)
...
(define-fun poly_inputs () F (ff.mul (ff.mul (ff.mul (ff.mul (ff.mul (as ff1 F) (ff.add (as ff1 F) (ff.mul (as ff1 F) fv2_31))) (ff.add (as ff1 F) (ff.mul (as ff3 F) fv2_30))) (ff.add (as ff1 F) (ff.mul (as ff15 F) fv2_29))) (ff.add (as ff1 F) (ff.mul (as ff255 F) fv2_28))) (ff.add (as ff1 F) (ff.mul (as ff65535 F) fv2_27))))
...
assert
  (not (= bvoutput
     (bvmul
       (bvadd (_ bv1 32)
              (bvmul (bvand (bvlshr bv2 (_ bv0 32)) (_ bv1 32)) (_ bv1 32)))
       (bvmul
         (bvadd (_ bv1 32)
                (bvmul (bvand (bvlshr bv2 (_ bv1 32)) (_ bv1 32)) (_ bv3 32)))
         (bvmul
           (bvadd (_ bv1 32)
                  (bvmul (bvand (bvlshr bv2 (_ bv2 32)) (_ bv1 32)) (_ bv15 32)))
           (bvmul
             (bvadd (_ bv1 32)
                    (bvmul (bvand (bvlshr bv2 (_ bv3 32)) (_ bv1 32)) (_ bv255 32)))
             (bvadd (_ bv1 32)
                    (bvmul (bvand (bvlshr bv2 (_ bv4 32)) (_ bv1 32)) (_ bv65535 32)))))))))
