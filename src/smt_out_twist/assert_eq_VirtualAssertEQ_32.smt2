;; Auto-generated (FF, flat) from Lean subtable: VirtualAssertEQ_32
(set-logic ALL)
...
(assert (not (= bvoutput (ite (= bv1 bv2) (_ bv1 32) (_ bv0 32)))))
